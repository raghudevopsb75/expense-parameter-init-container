...
//      }
      steps {
        sh 'docker build -t 739561048503.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME} .'
        ...
        sh 'docker push 739561048503.dkr.ecr.us-east-1.amazonaws.com/expense-parameter-init-container:${TAG_NAME}'
      }
    }
